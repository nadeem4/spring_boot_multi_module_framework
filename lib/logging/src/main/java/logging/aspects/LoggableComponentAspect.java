...
@Configuration
@Slf4j
public class LoggableComponentAspect {
	...
	public Object logAround( ProceedingJoinPoint joinPoint ) throws Throwable {
		...
		MDC.remove("method_name");
		MDC.remove("class_name");
		MDC.remove("execution_time_for_component_function_in_ms");
		return result;
	}
	
	@AfterReturning (pointcut = "logComponent()", returning = "response")
	...
	@AfterThrowing (value = "logComponent()", throwing = "ex")
